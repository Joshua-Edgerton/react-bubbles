...
- [ ] Explain what a token is used for.
  Tokens are used for authentication and identification.

- [ ] What steps can you take in your web apps to keep your data secure?
  By using session storage instead of local storage, or by using private / restricted routes.
...
(C)reate -  POST requests create and add additional data.
(R)ead -    GET requests retrieve and view data.
(U)pdate -  PUT requests modify existing data.
(D)estroy - DELETE requests remove data.
